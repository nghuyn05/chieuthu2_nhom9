                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-6 ">
                            <div class="detail-box">
                                ...
                                <p>
                                    Khám phá các loại len mềm mịn, đa dạng màu sắc, phù hợp cho mọi sản phẩm handmade của bạn.
                                </p>
                                <div class="btn-box">
                                    <a href="{{ route('product', 1) }}" class="btn1">
                                         Xem ngay
                                    </a>
                                </div>
                            </div>
            ...
            <div class="col-md-4">
                <div class="box ">
                    ...
                    <div class="detail-box">
                        ...
                        <p>Áp dụng cho đơn hàng từ 300.000đ</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="box ">
                    ...
                    <div class="detail-box">
                        ...
                        <p>Len mềm, bền màu, an toàn khi sử dụng</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 ml-auto">
                    ...
                    <p style="margin-top: 20px;margin-bottom: 30px;">
                        Cập nhật các mẫu len mới nhất với nhiều màu sắc và chất liệu đa dạng cho bạn lựa chọn.
                    </p>
                    <div class="btn-box">
                        <a href="{{ route('product', 1) }}" class="btn1">
                           Xem ngay
    ...
    <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted small text-center">{{ Str::limit($product->description, 80) }}</p>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="subscribe_form ">
                        ...
                        <p>Nhận thông tin sản phẩm mới và khuyến mãi hấp dẫn</p>
                        <form action="">
